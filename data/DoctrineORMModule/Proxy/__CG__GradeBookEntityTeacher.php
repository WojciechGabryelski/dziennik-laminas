 ...
 */
class Teacher extends \GradeBook\Entity\Teacher implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GradeBook\\Entity\\Teacher' . "\0" . 'id', '' . "\0" . 'GradeBook\\Entity\\Teacher' . "\0" . 'firstName', '' . "\0" . 'GradeBook\\Entity\\Teacher' . "\0" . 'lastName', '' . "\0" . 'GradeBook\\Entity\\Teacher' . "\0" . 'courses'];
        }
     ...
     * {@inheritDoc}
     */
    public function addCourse(\GradeBook\Entity\Course $course): void
    {
